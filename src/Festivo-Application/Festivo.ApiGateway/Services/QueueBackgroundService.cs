...
namespace Festivo.ApiGateway.Services;
    ...
    ILogger<QueueBackgroundService> logger) : BackgroundService
{
    ...
    private const string QueueName = "api-gateway-queue";
    private const string RoutingKey = "2-api-gateway.normal";
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var queue = await _channel.QueueDeclareAsync(
            ...
            arguments: new Dictionary<string, object?>()
            {
                ...
                { "x-dead-letter-routing-key", "2-api-gateway.error" }
            },
            cancellationToken: stoppingToken);
