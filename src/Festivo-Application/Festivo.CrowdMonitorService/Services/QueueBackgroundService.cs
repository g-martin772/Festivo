    ...
    ILogger<QueueBackgroundService> logger) : BackgroundService
{
    ...
    private const string QueueName = "crowd-monitor-queue";
    private const string RoutingKey = "4-crowd-monitor.normal";
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var queue = await _channel.QueueDeclareAsync(
            ...
            arguments: new Dictionary<string, object?>()
            {
                ...
                { "x-dead-letter-routing-key", "4-crowd-monitor.error" }
            },
            cancellationToken: stoppingToken);
